...
?>
        ...
        <td><a href="profile.php?id=<?php echo $dn1['user_id']; ?>"><?php echo htmlentities($dn1['user_name'], ENT_QUOTES, 'UTF-8'); ?></a></td>
...
?>
        ...
        <td><a href="profile.php?id=<?php echo $dn2['user_id']; ?>"><?php echo htmlentities($dn2['user_name'], ENT_QUOTES, 'UTF-8'); ?></a></td>
